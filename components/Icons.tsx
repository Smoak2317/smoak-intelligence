...
export const BrandLogo = ({ className = "w-10 h-10" }: { className?: string }) => (
  <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    {/* Abstract Diamond Hexagon */}
    <path d="M50 5 L90 28 V72 L50 95 L10 72 V28 Z" stroke="url(#logoGradient)" strokeWidth="6" strokeLinejoin="round" fill="white" fillOpacity="0.1" />
    
    {/* Internal Intelligence Nodes */}
    <path d="M50 25 V75 M28 38 L72 62 M72 38 L28 62" stroke="url(#logoGradient)" strokeWidth="3" strokeLinecap="round" opacity="0.6" />
    
    {/* Central Core */}
    <circle cx="50" cy="50" r="8" fill="url(#logoGradient)" filter="url(#glow)" />
    
    {/* Data Points */}
    <circle cx="50" cy="5" r="3" fill="#4f46e5" />
    <circle cx="90" cy="28" r="3" fill="#ec4899" />
    <circle cx="90" cy="72" r="3" fill="#ec4899" />
    <circle cx="50" cy="95" r="3" fill="#4f46e5" />
    <circle cx="10" cy="72" r="3" fill="#4f46e5" />
    <circle cx="10" cy="28" r="3" fill="#ec4899" />
  </svg>
);

export const DiamondIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M2.7 10.3a2.41 2.41 0 0 0 1.2 2.8l9.1 5.4a2 2 0 0 0 2 0l9.1-5.4a2.41 2.41 0 0 0 1.2-2.8l-2.9-7.4A2 2 0 0 0 20.5 2H3.5a2 2 0 0 0-1.9.9z" />
    <path d="M12 2v17" />
    <path d="m2.7 10.3 9.3 8.7" />
    <path d="m21.3 10.3-9.3 8.7" />
    <path d="M2 9.5h20" />
  </svg>
);
...
export const StoreIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M3 21h18v-8a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v8" />
    <path d="M3 7h18a2 2 0 0 1 2 2v2H1v-2a2 2 0 0 1 2-2" />
    <path d="M3 7l1-5h16l1 5" />
    <path d="M10 11v4" />
    <path d="M14 11v4" />
  </svg>
);
